  ...
  return (
    <div className="min-h-screen bg-white p-8">
      <div className="max-w-4xl mx-auto">
        <div className="flex justify-between items-center mb-8"><h1 className="text-2xl font-bold text-red-700">游戏管理</h1><div className="flex gap-2"><button onClick={() => setShowCreate(!showCreate)} className="px-4 py-2 bg-red-600 text-white rounded hover:bg-red-700 transition-colors">{showCreate ? '取消创建' : '+ 新建游戏局'}</button><button onClick={() => router.push('/gm/dashboard')} className="px-4 py-2 border border-gray-300 text-gray-600 rounded hover:bg-gray-50 transition-colors">返回GM中心</button></div></div>
