    ...
    <div className="min-h-screen bg-white p-8">
      <div className="max-w-lg mx-auto">
        ...
        <div className="space-y-4">
          ...
          <button onClick={() => router.push('/gm/manage-games')} className="w-full p-6 bg-white rounded-lg border border-gray-200 hover:border-red-300 hover:shadow-md text-left transition-all"><div className="text-xl font-semibold mb-1 text-gray-900">游戏局管理</div><div className="text-gray-500 text-sm">创建、开始、删除游戏局</div></button>
        </div>
      </div>
