        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full p-2 rounded border border-gray-300 focus:border-red-500 focus:ring-1 focus:ring-red-500 outline-none text-gray-900"
              required
              placeholder="请输入用户名"
            />
          </div>
          ...
          {error && (
            <div className={`text-sm p-2 rounded ${error.includes('成功') ? 'text-green-700 bg-green-50 border border-green-200' : 'text-red-700 bg-red-50 border border-red-200'}`}>
              {error}
            </div>
          )}
